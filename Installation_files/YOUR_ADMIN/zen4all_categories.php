    ...
    <div class="container-fluid">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3><?php echo HEADING_TITLE; ?>&nbsp;-&nbsp;<?php echo zen_output_generated_category_path($current_category_id); ?></h3>
        </div>
        <div class="panel-body">
          <form name="categoryInfo" enctype="multipart/form-data" id="categoryInfo" class="form-horizontal">
            ...
            <div class="tab-content">
              ...
              <div id="categoryTabs2" class="tab-pane fade in">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-6"><?php echo zen_draw_pull_down_menu('restrict_type', $type_array, '', 'id="restrict_type" class="form-control"'); ?>
                    <br>
            ...
            <div class="btn-group">
              ...
              <a href="<?php echo zen_href_link(FILENAME_Z4A_CATEGORIES_PRODUCT_LISTING, 'cPath=' . $cPath . '&cID=' . $cInfo->categories_id . ((isset($_GET['search']) && !empty($_GET['search'])) ? '&search=' . $_GET['search'] : '')); ?>" class="btn btn-warning" id="btncancel" name="btncancel"><i class="fa fa-undo"></i> Back </a>
            </div>
          </form>
        </div>
      </div>
