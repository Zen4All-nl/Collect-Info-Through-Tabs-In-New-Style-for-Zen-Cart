...
<div class="col-sm-9 col-md-6">
  <?php echo zen_draw_pull_down_menu('products_tax_class_id', $tax_class_array, $productInfo['products_tax_class_id']['value'], 'onchange="updateGross()" class="form-control"'); ?>
</div>