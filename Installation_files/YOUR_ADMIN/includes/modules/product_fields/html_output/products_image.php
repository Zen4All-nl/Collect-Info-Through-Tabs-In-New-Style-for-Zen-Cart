      ...
      <div class="panel-body">
        <div class="col-sm-8">
          <div id="mainImageThumb" data-toggle="modal" data-target="#imagePreviewModal" role="button">
              <?php if ($productInfo['product_image']['value'] != '') { ?>
                <?php echo zen_image(DIR_WS_CATALOG_IMAGES . $productInfo['product_image']['value'], '', SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'class="img-thumbnail" id="mainImage"'); ?>
              <br/>
          ...
          <?php echo zen_draw_hidden_field('products_image', $productInfo['product_image']['value'], 'id="mainProductImage"'); ?>
          <?php echo zen_draw_hidden_field('products_previous_image', $productInfo['product_image']['value']); ?>
          <div id="mainImagePath">
            <?php echo ($productInfo['product_image']['value'] != '' ? $productInfo['product_image']['value'] : NONE); ?></div>
        </div>
        <div class="col-sm-4">
          <div role="group">
              <?php if ($productInfo['product_image']['value'] != '') { ?>
...
<!-- /* BOF future code */ -->
<?php
if ($productInfo['product_image']['value'] != '' && $productInfo['products_id']['value'] != '') {
  $additionalImages = getAdditionalImages($productInfo['products_id']['value'], $productInfo['product_image']['value']);
} // if products_image
?>
<div class="panel panel-primary" id="additionalImages"<?php echo (($productInfo['product_image']['value'] != '' && $productInfo['products_id']['value'] != '') ? '' : ' style="display:none"') ?>>
