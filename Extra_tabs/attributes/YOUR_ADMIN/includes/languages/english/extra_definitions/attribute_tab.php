...
/**
 * attribute_tab.php
 * CITTTINS attribute tab
 *
 * @author  Zen4All (original author)
 * @copyright Copyright 2008-2017
 * @license http://www.gnu.org/licenses/gpl.txt GNU General Public License V2.0
 * @version $Id: attribute_tab.php,v 1.0
 * Zen4All 2017-11-21
 */

// common
define('TAB_TITLE_ATTRIBUTES', 'Attributes');
...
// edit modal
define('TITLE_EDIT_ATTRIBUTE', 'Attribute Edit');

// add modal
define('TITLE_ADD_ATTRIBUTE', 'Add Attribute');
